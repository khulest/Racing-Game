                ...
                if(username.isEmpty() || password.isEmpty() || email.isEmpty() || Surname.isEmpty() || Confirm_password.isEmpty()){
                    ...
                    if(password.compareTo(Confirm_password)==0){
                        if(isValid(password)){
                            ...
                            Toast.makeText(getApplicationContext(),"Please fill in profile for assistance",Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(RegistrationActivity.this,MainProfileActivity.class));
